// cover section -- page start lo kanipistadhi
  ...
  return (
    ...
    <div className='w-full inline-block'>
      <article className='flex flex-col items-start justify-end mx-5 sm:mx-10 relative h-[60vh] sm:h-[85vh]'>
        ...
        />
        <div className='w-full lg:w-3/4 sm:p-6 md:p-12 lg:p-16 flex flex-col items-start justify-center z-0 text-light'>
          ...
          <p className='hidden sm:inline-block mt-4 text-md:text-lg lg:text-xl font-in'>
            {blog.description}
          </p>
        </div>
      </article>
