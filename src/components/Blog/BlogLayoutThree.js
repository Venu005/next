  ...
  return (
    <div className='group flex flex-col items-center text-dark dark:text-light'>
      ...
      <div className='flex flex-col w-full mt-4'>
        <span className='uppercase text-accent dark:text-accentDark font-semibold text-base sm:text-sm'>
          {blog.tags[0]}
        </span>
        ...
        <span className='capitalize text-dark/50 font-semibold text-xs sm:text-base dark:text-light/50'>
